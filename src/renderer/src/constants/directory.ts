...
export type FlatDirectoryItem =
  | { type: 'folder'; folder: FolderRecord; depth: number; parentFolderId: number | null; nextSiblingId: number | null }
  | { type: 'chat'; chat: ChatRecord; depth: number; parentFolderId: number | null; nextSiblingId: number | null }
