...
function FolderRow({ folder, onOpen }: { folder: FolderRecord; onOpen: () => void }) {
  return (
    <TableRow className="cursor-default select-none" data-item-type="folder" data-item-id={folder.id} onDoubleClick={onOpen}>
      <TableCell>
...
function ChatRow({ chat, onOpen }: { chat: ChatRecord; onOpen: () => void }) {
  return (
    <TableRow className="cursor-default select-none" data-item-type="chat" data-item-id={chat.id} onDoubleClick={onOpen}>
      <TableCell>
        <span className="inline-flex items-center gap-2">
